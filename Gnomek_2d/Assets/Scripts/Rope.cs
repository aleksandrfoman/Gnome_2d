...
{
    public GameObject ropeSegmentPrefab;//Шаблон для создания новых звеньев

    List<GameObject> ropeSegments = new List<GameObject>();//Список обьектов RopeSegment

    //Веревка удлиняется или укорачивается
    public bool isIncreasing { get; set; }
    public bool isDecreasing { get; set; }

    //Обьект к которому присойденяем конец веревки
